...
<html>
    ...
    <body>
     ...
     <div class="container" style="width: 500px; height:600px;">
      ...
      <form action="/GoCheetaBooking_Clienttier/Customer/Function/addCustomerHelp.jsp" method="post" class="login-email">
	...
	<div class="input-group">
        ...
        <div class="input-group">             
         ...
         <p class="login-register-text" style="text-align:center;">Already have an account? <a href="/GoCheetaBooking_Clienttier/User/UI/UserLogin.jsp">Sign in</a>.</p>
         </form>
     </div>  
