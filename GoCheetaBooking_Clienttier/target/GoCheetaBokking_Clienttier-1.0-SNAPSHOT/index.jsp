...
<html>
    ...
    <body>
        <form action="/GoCheetaBooking_Clienttier/Customer/controller/addCustomer.jsp" method="post">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/GoCheetaBooking_Clienttier/Function/editCustomer.jsp?id=<% out.print(customer.getCustomerId()); %>">update</a>
                    <a href="/GoCheetaBooking_Clienttier/Customer/controller/deleteCustomer.jsp?id=<% out.print(customer.getCustomerId()); %>">delete</a>
                </td>
            </tr>
            <% } %>
        </tbody>
