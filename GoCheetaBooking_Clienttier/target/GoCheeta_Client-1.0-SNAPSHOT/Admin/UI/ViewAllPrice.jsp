        ...
        <tbody>
            ...
            <tr> 
                ...
                <td style="width:30%;text-align: center">
                   <a href="/GoCheeta_Client/Category/function/editCategory.jsp?id=" class="btn btn-primary"style="width:80px;height:40px;text-align:center;margin-right:5px;">Update</a>
                   <a href="/GoCheeta_Client/Category/controller/deleteCategory.jsp?id=" class="btn btn-danger" style="width:80px;height:40px;text-align:center;margin-left:5px;">Delete</a>
                </td>
            </tr>
             <tr> 
