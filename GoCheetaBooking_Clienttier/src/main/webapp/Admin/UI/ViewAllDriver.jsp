...
<%@ include file="/Admin/UI/adminMenu.jsp" %>    
    ...
    <nav>
        <div class="sidebar-button">
            ...
            <span class="dashboard">Driver Details</span>
        </div>
    ...
    <div>
        ...
        <a href="../UI/AddNewDriver.jsp" class="btn btn-info" style="width:80px;height:40px;text-align:center;margin-left:12%;margin-top:5%">Add</a>
        ...
        <input type="text" id="myInput" onkeyup='tableSearch()' placeholder="Name" style="padding:10px;width:40%;margin-left:50%;border-radius:30px;border: 2px solid #e7e7e7;padding: 12px 20px;
               font-size: 1rem;border-radius: 30px;background: transparent;outline: none;transition: .3s;"><img src="/GoCheetaBooking_Clienttier/image/icon/search.png" style="width:35px;height:35px;margin-left:-50px;margin-top:8px;">
        </div>
        ...
        <tbody>
            ...
            <tr> 
                ...
                <td style="width:30%;text-align: center">
                   <a href="/GoCheetaBooking_Clienttier/Admin/Function/editVehicleDriverDetails.jsp?id=<% out.print(vehicle.getDriverMobile()); %>" class="btn btn-primary"style="width:80px;height:40px;text-align:center;margin-right:5px;">Update</a>
                   <a href="/GoCheetaBooking_Clienttier/Admin/controller/deleteVehicle.jsp?id=<% out.print(vehicle.getDriverMobile()); %>" class="btn btn-danger" style="width:80px;height:40px;text-align:center;margin-left:5px;">Delete</a>
                </td>
            </tr>
            <% } %>
