...
<html>
    ...
    <body>
     ...
     <div class="container" style="width: 500px; height:580px;">
      ...
      <form action="/GoCheetaBooking_Clienttier/Admin/Function/addVehicleHelp.jsp" method="post" class="login-email">
	...
	<div class="input-group">
        ...
        <div class="input-group">             
             <input type="submit" value="Sign Up" class="btn">
              ...
              <p class="login-register-text" style="margin-top:-12px;text-align:center;">Don't have an account? <a href="/GoCheetaBooking_Clienttier/Driver/UI/DriverRegister.jsp">Register</a>.</p>  
         </form>
     </div> 
