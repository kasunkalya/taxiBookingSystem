...
<html>
    ...
    <body>
        <a href="/GoCheetaBooking_Clienttier/Category/UI/AddNewCategory.jsp" class="btn btn-info" style="width:80px;height:40px;text-align:center;margin-left:10%;margin-top:10%">Add</a>
        ...
        <tbody>
            ...
            <tr> 
                ...
                <td style="width:30%;text-align: center">
                   <a href="/GoCheetaBooking_Clienttier/Category/function/editCategory.jsp?id=<% out.print(category.getCategoryId()); %>" class="btn btn-primary"style="width:80px;height:40px;text-align:center;margin-right:5px;">Update</a>
                   <a href="/GoCheetaBooking_Clienttier/Category/controller/deleteCategory.jsp?id=<% out.print(category.getCategoryId()); %>" class="btn btn-danger" style="width:80px;height:40px;text-align:center;margin-left:5px;">Delete</a>
                </td>
            </tr>
            <% } %>
        </tbody>
